...
export default function Home() {
  return (
    <div className=" min-h-screen ">
      ...
      <footer className=" bg-gradient-to-r from-secondary-700/50 to-[#4d2308] dark:bg-[#1a1d29] min-h-36 flex flex-col gap-6 py-10 px-2 lg:px-8">
        ...
        <div className="flex items-center justify-between ">
          <div className=' flex flex-shrink-0 items-center gap-2'>
            ...
            <span className=' text-xl font-bold text-white dark:text-secondary-600'>Natnael</span>
          </div>
        </div>
